                                ...
                                <div class="box box-form box-form-tertiary ">
                                    ...
                                    <div class="box-form-body box-form-body-primary">
                                        <div class="row row-15 row-gutters-14">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                                    ...
                                                    <select id="category" name="category" class="form-control">
                                                        ...
                                                        <option
                                                            {{ (isset($player) ? $player->category : '') == 'U-12' ? 'selected' : '' }}value="U-12">
                                                            U-12(Born on or After 1.1.2010)</option>
                                                        <option
                                                            {{ (isset($player) ? $player->category : '') == 'U-14' ? 'selected' : '' }}value="U-14">
                                                            U-14(Born on or After 1.1.2008)</option>
                                                        <option
                                                            {{ (isset($player) ? $player->category : '') == 'U-16' ? 'selected' : '' }}value="U-16">
                                                            U-16(Born on or After 1.1.2006)</option>
                                                        <option
                                                            {{ (isset($player) ? $player->category : '') == 'U-18' ? 'selected' : '' }}value="U-18">
                                                            U-18(Born on or After 1.1.2004)</option>
                                                        <option
                                                            {{ (isset($player) ? $player->category : '') == 'Mens"' ? 'selected' : '' }}value="Mens">
                                                            U-21</option>
                                                        <option
                                                            {{ (isset($player) ? $player->category : '') == 'Mens/Women' ? 'selected' : '' }}value="Mens/Women">
                                                            Mens/Womens</option>
                                                        <option
                                                            {{ (isset($player) ? $player->category : '') == 'Mens/Women' ? 'selected' : '' }}value="Mens/Women">
                                                            Veteran</option>
                                                ...
                                                <div
                                                    ...
                                                    <select id="district" name="district" class="form-control">
                                                        ...
                                                        <option
                                                            ...
                                                            value="Fatehgarh Sahib">Fatehgarh Sahib</option>
                                                        <option
                                                        ...
                                                        <option
                                                            ...
                                                            value="Tarn Taran">Tarn Taran</option>
                                                    </select>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group {{ $errors->has('dob_crt') ? 'has-error' : '' }}">
